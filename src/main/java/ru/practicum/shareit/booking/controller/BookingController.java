...
public class BookingController {
    ...
    @PostMapping
    public BookingDto post(@RequestHeader(HEADER) Long userId, @RequestBody BookingDto bookingDto) {
    ...
    @GetMapping("/owner")
    List<BookingDto> getAllBookingByOwner(@RequestHeader(HEADER) Long userId) {
